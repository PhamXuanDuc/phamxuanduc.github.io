...
@Component({
    selector: 'app-contract-management-modal',
    templateUrl: './contract-management-modal.component.html',
    styleUrls: ['./contract-management-modal.component.scss']
})
export class ContractManagementModalComponent implements OnInit {
