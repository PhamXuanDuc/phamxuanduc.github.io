...
import {ContractManagementModalComponent} from "./contract-management-modal/contract-management-modal.component";
...
export class ContractManagementComponent implements OnInit {
    ...
    openCreateModal(item: any) {
        const modalRef = this.modalService.open(ContractManagementModalComponent, {
            centered: true,
            size: 'xl',
            backdrop: 'static'
        });
