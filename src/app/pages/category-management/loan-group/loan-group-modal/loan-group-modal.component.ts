...
@Component({
  selector: 'app-loan-group-modal',
  templateUrl: './loan-group-modal.component.html',
  styleUrls: ['./loan-group-modal.component.scss']
})
export class LoanGroupModalComponent implements OnInit {
  ...
  create() {
    ...
    this.loanGroupService.create(this.form.value).subscribe(res => {
      if (res && res.data) {
  ...
  update() {
    this.loading = true;
    this.loanGroupService.update(this.form.value).subscribe(res => {
      if (res && res.data) {
