...
import {LoanGroupService} from "../../../core/services/module/category-management/loan-group.service";
import Swal from "sweetalert2";
import {LoanGroupModalComponent} from "./loan-group-modal/loan-group-modal.component";

@Component({
    selector: 'app-loan-group',
    templateUrl: './loan-group.component.html',
    styleUrls: ['./loan-group.component.scss']
})
export class LoanGroupComponent implements OnInit {
    ...
    getAllByCondition() {
        ...
        this.loanGroupService.getByCondition(json).subscribe(res => {
            if (res && res.data) {
    ...
    openCreateModal(item: any) {
        const modalRef = this.modalService.open(LoanGroupModalComponent, {
            centered: true,
            size: 'lg',
            backdrop: 'static'
        });
    ...
    deleteItem(item: any) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                this.loading = true;
                this.loanGroupService.delete(json).subscribe(res => {
