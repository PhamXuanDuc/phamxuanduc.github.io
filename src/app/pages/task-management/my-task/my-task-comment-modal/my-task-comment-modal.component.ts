...
@Component({
  selector: 'app-my-task-comment-modal',
  templateUrl: './my-task-comment-modal.component.html',
  styleUrls: ['./my-task-comment-modal.component.scss']
})
export class MyTaskCommentModalComponent implements OnInit {
  @Input() title: any;
  @Input() item: any;
