...
@Component({
  selector: 'app-my-task-modal',
  templateUrl: './my-task-modal.component.html',
  styleUrls: ['./my-task-modal.component.scss']
})
export class MyTaskModalComponent implements OnInit {
  @Input() title: any;
  @Input() item: any;
