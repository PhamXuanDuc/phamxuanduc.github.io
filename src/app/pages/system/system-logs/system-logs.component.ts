...
import {ProductModalComponent} from "../../category-management/product/product-modal/product-modal.component";
import Swal from "sweetalert2";
import {SystemLogsService} from "../../../core/services/module/system/system-logs.service";
...
export class SystemLogsComponent implements OnInit {
  ...
  getAllByCondition() {
    ...
    this.systemLogsService.getByCondition(json).subscribe(res => {
      if (res && res.data) {
